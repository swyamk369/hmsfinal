...
export const ROLE_DEFS: RoleDef[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      P.ONLINE_BOOKING_READ,
      P.PATIENT_PORTAL_ACCESS_READ,
    ],
  },
  {
    ...
    permissions: [
      ...
      P.ONLINE_BOOKING_READ,
      P.ONLINE_BOOKING_MANAGE,
      P.ONLINE_BOOKING_APPROVE,
      P.ONLINE_BOOKING_REJECT,
      P.ONLINE_BOOKING_RESCHEDULE,
      P.PATIENT_PORTAL_ACCESS_READ,
      P.PRESCRIPTION_REFILL_READ,
      P.PRESCRIPTION_REFILL_MANAGE,
    ],
  },
  {
    code: ROLES.DOCTOR,
