...
export const nursingApi = {
  ...
  addVitals: (t: string, id: string, body: Partial<Vitals>) =>
    apiPost<Vitals>(`/nursing/admissions/${id}/vitals`, body, t),
  addNote: (t: string, id: string, note: string) =>
    apiPost<NursingNote>(`/nursing/admissions/${id}/notes`, { note }, t),
